...
```bash
ansible-builder build --file ee123.yaml --tag ee123:latest --container-runtime podman
```
...
- **ee123.yaml**: This is your EE's "blueprint." It's the main definition file that ansible-builder will use to construct your image.
- **ee123-template.yaml**: This is the Ansible self-service automation portal template file that generated this. You can import it and use it as a base to create new templates for your portal.
...
```bash
# This command uses your 'ee123.yaml' file to build an image
# and tags it as 'ee123:latest'
...
```bash
ansible-navigator run playbook.yml --eei ee123:latest --pull-policy missing
```
...
podman tag ee123:latest your-pah-hostname/ee123:latest

# Login to your Private Automation Hub
podman login your-pah-hostname

# Push the image
podman push your-pah-hostname/ee123:latest
```
...
podman tag ee123:latest your-internal-registry.com/ee123:latest
podman login your-internal-registry.com
podman push your-internal-registry.com/ee123:latest
```
...
If you want to reuse this execution environment template for future projects, you can import the generated **ee123.yaml** file into your self-service automation portal.
...
2. **Import from Git repository**: Enter the Git SCM URL containing your `ee123.yaml` file, click **Analyze** to validate, review the details, then click **Import**.
